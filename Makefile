...
generate_grading_percent_distribution_per_genre_plot:
	python -c "from main import generate_grading_percent_distribution_per_genre_plot; generate_grading_percent_distribution_per_genre_plot()"
